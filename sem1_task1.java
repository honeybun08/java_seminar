...
public static void main(String[] args) {
    ...
    int randomNumber = random.nextInt(2001); // исключает случайное в диапазоне

    System.out.println(randomNumber);

    System.out.println(Integer.toBinaryString(randomNumber));
    System.out.println(Integer.toBinaryString(randomNumber).length());// пишет номер след.старшего бита
